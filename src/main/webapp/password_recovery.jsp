    ...
    <c:if test="${empty param.success}">
        <c:if test="${not empty param.recovery_error}">
            <div class="alert alert-danger" role="alert">
                <c:choose>
                    <c:when test="${param.recovery_error == 'invalid_token'}"> <fmt:message key="recovery_error_token"/>
                    </c:when>
                    <c:when test="${param.recovery_error == 'user'}"> <fmt:message key="recovery_error_username"/>
                    </c:when>
